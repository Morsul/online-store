...
export class ProductsHeadline{
  ...
  constructor(){
    this._filtredProductCount = elementGenerator.createParagraph({className: 'shown-count', text: 'Found 0 products'});
    this._search = elementGenerator.createInput('text', {className: 'search', placeholder: 'Type category or brand name'});
