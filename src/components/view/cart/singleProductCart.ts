...
export class SingleProductCart extends SingleProduct {
  ...
  createProduct(index?: number){
    ...
    prodInfoWrap.append (this.tagList.title, this.tagList.description, this.tagList.category, this.tagList.brand, this.tagList.rating,
                          this.tagList.stock, this.tagList.price, this.tagList.discount, blockAddRemove, this.tagList.goToSingle
                        );
